      ...
      <Container>
        <Row className="all-text-white">
          <Col md={12} className="d-md-flex justify-content-md-between align-items-center	">
            <div>
              <h1 className="fw-bold">Animated Headlines</h1>
              <h6 className="mb-md-0">We are a creative studio focusing on branding &amp; web design</h6>
            </div>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item">Animated Headlines</li>
              </ol>
            </nav>
          </Col>
        </Row>
