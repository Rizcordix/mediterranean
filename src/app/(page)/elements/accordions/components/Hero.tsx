...
const Hero = () => {
  return (
    <div className="bg-overlay-dark-7 py-7" style={{ background: `url(${bgImg.src}) repeat`, backgroundSize: 'cover' }}>
      <Container>
        <Row className="all-text-white">
          <Col md={12} className="d-md-flex justify-content-md-between align-items-center">
            <div>
              <h1 className="fw-bold">Accordions</h1>
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item">Accordion Modules</li>
              </ol>
            </nav>
          </Col>
        </Row>
