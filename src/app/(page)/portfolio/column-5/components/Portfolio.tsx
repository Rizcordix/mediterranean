        ...
        <Row>
          <Col md={12} className="p-0">
            <div className="nav justify-content-center grid-menu" data-target=".filter-container">
              <ul className="nav-tabs nav-tabs-style-1 text-center px-2 p-md-0 m-0 mb-4">
            ...
            <div className="portfolio-wrap grid items-5 items-padding filter-container" data-isotope='{ "layoutMode": "masonry" }'>
