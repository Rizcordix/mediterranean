        ...
        <Row className="py-0 py-md-5 justify-content-between align-items-center">
          <Col sm={10} lg={6} className="all-text-white my-5 mt-md-0 position-relative">
            <div className="text-start py-0 py-md-5 my-5">
              <h6>You found it!</h6>
              <h2 className="display-4 fw-normal">Professional eBook Ghostwriting Services.</h2>
              <p className="mb-4 display-8 lh-0 fw-normal">
                At Meditarranean Publishing, we transform your vision, knowledge, and story into a professionally written eBook. Our expert ghostwriters craft compelling, polished, and original content that reflects your voice—while you take full credit as the author.
              </p>
