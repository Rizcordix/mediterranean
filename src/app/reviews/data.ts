...
export const careersData: CareersType[] = [
  {
    title: 'How many free samples can i redeem?',
    description:
      "Due to the limited quantity, each member's account is only entitled to 1 unique free sample. You can check out up to 4 free samples in each checkout. We take such matters very seriously and will look into individual cases thoroughly. We provide digital transformation solutions, enabling companies to make their visions reality. With us at your side, you will find the IT solution to achieve your strategic and financial goals.",
  },
  {
  ...
  {
    title: 'Can i pay without a paypal account?',
    description:
