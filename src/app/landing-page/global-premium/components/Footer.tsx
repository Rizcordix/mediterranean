          ...
          <Row>
            <Col md={8} className="mx-auto">
              <div className="widget text-center mt-0">
                <Link href="/global-premium" className="footer-logo mb-4 d-block">
                ...
                <div className="copyright-links my-2">
                  <ul className="list-inline">
                    ...
                    <li className="list-inline-item ps-2">
                      <Link className="list-group-item-action" href="https://www.mediterraneanpublishing.com/privacy" target='_blank'>Privacy Policy</Link>
                    </li>
                    <li className="list-inline-item ps-2">
                      <Link className="list-group-item-action pe-0" href="https://www.mediterraneanpublishing.com/terms" target='_blank'>terms of service</Link>
                    </li>
                  </ul>
                </div>
