    ...
    <section className="hero-container pattern-overlay-2" aria-labelledby="hero-heading">
      ...
      <div className="hero-content">
        <div className="hero-left">
          ...
          >
            Build Your Author Legacy. Become an International Thought Leader.
          </h1>

          <p className={`hero-subheadline ${isVisible ? "visible delay-1" : ""}`}>
            For ambitious authors ready to impact readers globally. Complete book
            publishing, international expansion, brand building, and career
            transformation—all included.
          </p>
