...
const TopNavbar = () => {
  ...
  return (
    <header className={`navbar-transparent navbar-sticky navbar-primary ${scrollY > 80 && 'navbar-sticky-on'}`}>
      ...
      <nav className="navbar navbar-expand-lg">
        <Container>
          <Link className="navbar-brand" href="/">
            <Image className="navbar-brand-item" src={logoWhite} alt="Larexa" />
          </Link>
          <button
            onClick={toggle}
          ...
          <div className="navbar-nav">
            ...
            <div className="nav-item border-0 d-none d-lg-inline-block align-self-center">
              <Button variant="white" size="sm" className="mb-0">
                Buy Now!
              </Button>
            </div>
          </div>
